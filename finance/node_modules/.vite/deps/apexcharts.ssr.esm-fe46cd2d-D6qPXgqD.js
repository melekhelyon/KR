...
var Wt = class {
	...
	getFirstDataPoint() {
		...
		return this.activeSeriesIndex = new U(this.w).getActiveConfigSeriesIndex(), t[this.activeSeriesIndex] && t[this.activeSeriesIndex].data && t[this.activeSeriesIndex].data.length > 0 && t[this.activeSeriesIndex].data[0] !== null && typeof t[this.activeSeriesIndex].data[0] < "u" ? t[this.activeSeriesIndex].data[0] : null;
	}
	isMultiFormat() {
...
var as = class {
	...
	drawTooltip(t) {
		...
		if (s.classList.add("apexcharts-tooltip"), e.config.tooltip.cssClass && s.classList.add(e.config.tooltip.cssClass), s.classList.add(`apexcharts-theme-${this.tConfig.theme || "light"}`), e.config.chart.accessibility.enabled && e.config.chart.accessibility.announcements.enabled && (s.setAttribute("role", "tooltip"), s.setAttribute("aria-live", "polite"), s.setAttribute("aria-atomic", "true"), s.setAttribute("aria-hidden", "true")), e.dom.elWrap.appendChild(s), e.globals.axisCharts) {
			...
			this.xAxisTicksPositions = new wt(this.w, this.ctx).getXAxisTicksPositions();
		}
...
var ft = class {
	constructor(t, e, s) {
		...
		this.stackedSeriesTotals = new V(this.w).getStackedSeriesTotals(this.w.config.series.map((r, n) => a.indexOf(n) === -1 ? n : -1).filter((r) => r !== -1)), this.barHelpers = new $s(this);
	}
...
//# sourceMappingURL=apexcharts.ssr.esm-fe46cd2d-D6qPXgqD.js.map